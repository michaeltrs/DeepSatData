...
python dataset/labelled_dense/extract_parcel_ground_truths.py --ground_truths_file $ground_truths_file \
                                                           --raster_labels_dir $labels_dir \
                                                           --products_dir $products_dir \
                                                           --savedir $labels_dir \
                                                           --res $res \
                                                           --sample_size $sample_size \
...
python dataset/labelled_dense/extract_images_for_parcel_labels.py --ground_truths_dir $labels_dir \
                                                           --products_dir $products_dir \
                                                           --savedir $windows_dir \
                                                           --bands $bands \
                                                           --res $res \
...
python dataset/labelled_dense/make_image_timeseries_for_parcel_labels.py --ground_truths_dir $labels_dir \
                                                                  --products_dir $products_dir \
