...
if __name__ == "__main__":
    ...
    windows_dir = '/media/michaeltrs/sdb/HD2/Data/Satellite_Imagery/RPG/T31FM_18/IMAGES'
    savedir = '/media/michaeltrs/sdb/HD2/Data/Satellite_Imagery/RPG/T31FM_18/TIMESERIES2'
    if not os.path.exists(savedir):
        os.makedirs(savedir)
